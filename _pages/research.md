...
One of the mechanisms by which *N. gonorrhoeae* evades the host adaptive immune system is through rapid variation of its surface antigens. One of the most abundant, diverse, and immunogenic surface antigens is Opa, a surface-adhesion protein that is encoded by multiple *opa* gene paralogs that undergo phase variation to rapidly switch expression. Standard short-read sequencing platforms (such as Illumina) are unable to capture gene paralogs; as such, we have had only a very limited understanding of *opa* diversity in *N. gonorrhoeae*. However, the development of accurate long-read sequencing technology provides an opportunity to characterize and define the *opa* repertoire and its evolutionary dynamics. I generated new datasets, developed genomics approaches, and developed new frameworks to characterize and analyze *opa* sequence and antigenic evolution. Our study showed that N. gonorrhoeae has a continuously evolving opa repertoire that leads to diverse opa alleles even in closely related strains. An implication of these results is that hosts will likely be exposed to different Opa types upon reinfection and there is possible antigenic escape in vivo in chronic or undiagnosed infections. Furthermore, the development of approaches to study antigenic diversity and evolution in Opa may be applicable in studying evolution of other antigens in *N. gonorrhoeae* as well as in other bacterial species with multi-locus and/or phase-variable genes. 
